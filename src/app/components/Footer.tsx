    ...
    <footer className="bg-[#1a1a1a] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Professional cleaning services for your home and office. Quality you can trust.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-gray-400">Car Cleaning</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Clean Street, City, State 12345</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@cleaningservice.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
          <p>&copy; 2026 Cleaning Service. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
