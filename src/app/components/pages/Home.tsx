  ...
  return (
    <div className="w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              <h1 className="text-4xl md:text-5xl lg:text-6xl mb-6 leading-tight">{page?.heroTitle}</h1>
              <p className="text-lg md:text-xl mb-8 text-gray-300">{page?.heroSubtitle}</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/get-quote" className="px-8 py-4 bg-[#F4C430] text-black rounded-full hover:bg-[#e5b520] transition-all transform hover:scale-105 text-center font-medium">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((stat: any, index: number) => (
              <motion.div key={stat.label} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }}>
                <div className="text-4xl text-[#F4C430] mb-2">{stat.number}</div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative">
                ...
                >
                  <div className="text-5xl font-bold text-center">{aboutSection.experienceBadge}</div>
              ...
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[#6B7280] uppercase tracking-wide text-sm font-medium">{aboutSection.eyebrow}</span>
                </div>

                <h2 className="text-4xl md:text-5xl mb-6 text-gray-900">{aboutSection.title}</h2>

                {aboutSection.paragraphs?.map((paragraph: string) => (
                  <p key={paragraph} className="text-gray-600 mb-4 leading-relaxed">{paragraph}</p>
                ))}
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to="/get-quote" className="px-8 py-4 bg-[#F4C430] text-black rounded-full hover:bg-[#e5b520] transition-colors font-medium text-center uppercase tracking-wide">
                    Enquire Now
                  </Link>
                  {business?.phoneDisplay && (
                    <a href={business.phoneHref} className="px-8 py-4 bg-white border-2 border-gray-300 text-gray-900 rounded-full hover:border-[#F4C430] transition-colors font-medium text-center flex items-center justify-center gap-3">
      ...
      <section className="py-20 bg-gradient-to-br from-[#3D1810] to-[#2a1410] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <h2 className="text-4xl mb-4">{page?.content?.testimonialsTitle}</h2>
          </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-[#6B7280] uppercase tracking-wide text-sm font-medium">{clientsSection.eyebrow}</span>
              </div>
              <h2 className="text-4xl md:text-5xl mb-4 text-gray-900">{clientsSection.title}</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">{clientsSection.description}</p>
            </motion.div>
                      ...
                      <div className="flex flex-col items-center justify-center text-center h-full">
                        <div className="w-14 h-14 rounded-2xl bg-white border border-gray-200 flex items-center justify-center mb-3 overflow-hidden">
                          {clientLogo ? (
                            ...
                            <Icon className="w-10 h-10 text-gray-400 group-hover:text-[#F4C430] transition-colors" />
                          )}
                        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-gray-300 uppercase tracking-wide text-sm font-medium">{certificationsSection.eyebrow}</span>
              </div>
              <h2 className="text-4xl md:text-5xl mb-4">{certificationsSection.title}</h2>
              <p className="text-gray-300 max-w-2xl mx-auto">{certificationsSection.description}</p>
            </motion.div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {certificationsSection.groups?.map((group: any, index: number) => {
                const Icon = iconMap[group.icon as keyof typeof iconMap] || Shield;
                return (
                  <motion.div
                    key={group.title}
                    initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <h2 className="text-4xl mb-4">Explore Our Cleaning Blog</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center mt-8">
            <Link to="/blog" className="inline-flex items-center px-6 py-3 bg-[#F4C430] text-black rounded-full hover:bg-[#e5b520] transition-colors">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-300 uppercase tracking-wide text-sm font-medium">{careersSection.eyebrow}</span>
                </div>

                <h2 className="text-4xl md:text-5xl mb-6 leading-tight">{careersSection.title}</h2>
                <p className="text-gray-300 mb-8 text-lg leading-relaxed">{careersSection.description}</p>
                ...
                <Link to="/join-team" className="inline-flex items-center px-8 py-4 bg-[#F4C430] text-black rounded-full hover:bg-[#e5b520] transition-all transform hover:scale-105 font-medium">
              ...
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative">
                ...
                >
                  <div className="text-5xl font-bold text-center">{careersSection.staffCount}</div>
